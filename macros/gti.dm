...
_gtiadministratoremail_ {lh92@cs.waikato.ac.nz}
...
<table border="0">
  ...
  _If_(_4_,<tr><td align="right">&nbsp;</td><td>
     ...
     _If_(_4_ eq _gtidownloadglihelp, <a href="_4_">, <a href="_httpprefix_/_4_">)_textgtidownloadtargetfile_</a>
...
_textgtiglihelpzipfile_ {Clicke here to download the operational files for GLI Help}
