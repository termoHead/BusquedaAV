...
<table cellspacing="0" cellpadding="0" class="contenedorFormulario">
  <tbody><tr class="dark">
    <td><input type="checkbox" onclick="setChecked(new Array('arti','conv','event','libros','norm','plan','prog','proy','tes','exten'))">
...
<option selected="" value="">rango de relevancia
  ...
  <tr class="dark">
    <td><input type="checkbox" value="extension" name="cc" id="exten">
      <label>Proyectos de extensión</label></td>
    <td></td>
    <td></td>
  </tr>
</tbody></table>
