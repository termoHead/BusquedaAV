...
_textabgs_ [l=ar] {عن برنامج Greenstone}  
_textgsdocs_ [l=ar] {وثائق Greenstone}  

_textdescradmin_ [l=ar] {تمكنك من إضافة مستخدمين جدد، وإعطاء تعليمات فنية عن عملية تثبيت برنامج Greenstone}  

_textdescrgogreenstone_ [l=ar] {تخبرك عن برنامج Greenstone ومشروع المكتبة الرقمية لنيوزيلاندا حيث بدأ النظام.}  

_textdescrgodocs_ [l=ar] {أدلة Greenstone}  
...
_textdescrcollector_ [l=ar] {يسبق هذا واجهة مكتبى Greenstone  وللأغراض العملية، يجب استخدام واجهة مكتبي Greenstone بدلا من المجمع..}  

package depositor

_textdepositor_ [l=ar] {المودع}  
